...
$lang = array_merge($lang, [
    ...
    'ACP_NEXTCLOUDCALENDAR_FRONTEND_POSITION_EXPLAIN' => "Controle ou les utilisateurs voient le lien vers le formulaire en dehors d'un message. Le marqueur [nextcloudcalendar] dans les messages n'est pas modifie.",
    'ACP_NEXTCLOUDCALENDAR_FRONTEND_POSITION_NAVIGATION' => 'Navigation principale',
    'ACP_NEXTCLOUDCALENDAR_FRONTEND_POSITION_INDEX' => 'Page d accueil au-dessus de la liste des forums',
