...
$lang = array_merge($lang, [
    ...
    'ACP_NEXTCLOUDCALENDAR_FRONTEND_POSITION_EXPLAIN' => 'Controls where users see the submission form link outside a post. The tile uses the forum look of the active theme. The [nextcloudcalendar] placeholder inside posts is not affected.',
    'ACP_NEXTCLOUDCALENDAR_FRONTEND_POSITION_NAVIGATION' => 'Main navigation',
    'ACP_NEXTCLOUDCALENDAR_FRONTEND_POSITION_QUICKLINKS' => 'Quick links menu',
    'ACP_NEXTCLOUDCALENDAR_FRONTEND_POSITION_INDEX_BUTTON' => 'Board index button above the forum list',
    'ACP_NEXTCLOUDCALENDAR_FRONTEND_POSITION_INDEX_TILE' => 'Board index tile above the forum list',
    ...
    'ACP_NEXTCLOUDCALENDAR_FRONTEND_ICON_EXPLAIN' => 'FA class for the link and tile, e.g. fa-calendar-plus-o, fa-calendar or calendar-check-o.',
    ...
    'ACP_NEXTCLOUDCALENDAR_TIMEZONE_INVALID' => 'The timezone "%s" is not a valid PHP timezone identifier. The previous timezone has been kept.',
